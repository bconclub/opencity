...
export function createBlenderVehicle(T,id){
 ...
 return{group,body,front,wheels,get wheelRadius(){return rig?.wheelRadius||(id==='cybertruck'?.43925:id==='kitt'?.324:.35);},get wheelbase(){return rig?.wheelbase;},setPaint,ready,updateDrive};
}
