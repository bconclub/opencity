...
if('serviceWorker' in navigator&&window.isSecureContext){
 let waiting=null,reloadPending=false,reloading=false,hadController=!!navigator.serviceWorker.controller;
 ...
 navigator.serviceWorker.addEventListener('controllerchange',()=>{if(!hadController){hadController=true;return;}reloadPending=true;updateWhenIdle();});
