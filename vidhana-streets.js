...
export async function installVidhanaStreets(map){
 ...
 add({id:'vidhana-lane',type:'fill',filter:['all',['==',['get','kind'],'lane'],['!=',['get','name'],'Devaraj Urs Road']],paint:{'fill-color':'#f1edd8','fill-opacity':.92,'fill-antialias':true}});
 add({id:'vidhana-zebra',type:'fill',filter:['==',['get','kind'],'zebra'],paint:{'fill-color':'#f1edd8','fill-opacity':.92,'fill-antialias':true}});
