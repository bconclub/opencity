export async function installVidhanaStreets(map){
 ...
 add({id:'vidhana-kerb',type:'fill',filter:['==',['get','kind'],'kerb'],paint:{'fill-color':['match',['get','kerbTone'],0,'#2d6a4f','#f8f9fa'],'fill-antialias':true}});
 ...
 add({id:'vidhana-barriers',type:'circle',minzoom:17,filter:['in',['get','kind'],['literal',['barrier_police','barrier_cone','barrier_post']]],paint:{'circle-radius':['match',['get','kind'],'barrier_police',5,'barrier_cone',3,3],'circle-color':['match',['get','kind'],'barrier_police','#d4a017','barrier_cone','#1e56a0','#7a7568'],'circle-stroke-width':1,'circle-stroke-color':'#2f2b22'}});
