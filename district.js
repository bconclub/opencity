...
export async function installDistrict(map){
 ...
 window.pickDistrictFocus=()=>{
  ...
  const near=new T.Vector3(0,0,-1).applyMatrix4(inverse),far=new T.Vector3(0,0,1).applyMatrix4(inverse);
