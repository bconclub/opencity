...
(async()=>{
 ...
 const dir=path.join(__dirname,'../experiments/osm2world/coverage-500-classified/asset');
 ...
 fs.writeFileSync(path.join(__dirname,'street-500-material-results.json'),JSON.stringify(report,null,2)+'\n');console.log(report);
})();
