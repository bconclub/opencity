...
(async()=>{
 ...
 const dir=path.join(__dirname,'street-500-gap-export/asset');
 ...
 fs.writeFileSync(path.join(__dirname,'street-500-gap-export/material-results.json'),JSON.stringify(report,null,2)+'\n');console.log(report);
})();
