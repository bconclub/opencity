// Last verified hardware tier. Full-HD 4x AA failed the frame-time gate.
export const MAX_AA_DEVICE_PIXELS = 1100 * 760;
// Match MapLibre5.7.2's context defaults; a hybrid driver may still choose differently.
