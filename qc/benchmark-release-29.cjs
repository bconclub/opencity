...
(async()=>{
 ...
 fs.writeFileSync('qc/release-29-performance.json',JSON.stringify({device:'Same Windows host, Edge headless SwiftShader software renderer',viewport:[1100,760],results},null,2));
