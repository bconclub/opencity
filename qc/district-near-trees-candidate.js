...
export async function installDistrict(map){
 ...
 const nearTrees=createNearbyTreeLOD(T,{parent:vegetation,positions:treePositions,trunk,crowns,radius:80,maxDesktop:32,maxMobile:16,onChange:()=>map.triggerRepaint()});
 window.prepareNearbyTrees=()=>nearTrees.ready;
