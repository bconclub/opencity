...
| Cybertruck dimensions and lamp export | Separate Blender candidate, not promoted | `cybertruck-next-audit.md`; official dimensions checked. First candidate passed numerical checks but failed visual review of wheel covers, sill and bed clearance. Revision under repair. |
