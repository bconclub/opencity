...
| Portico, stairs and coherent building heights | Integrated locally in9df5546 | `vidhana-stair-filter-review.md`;45physical steps, analytically filtered tread/riser lighting and shadows. Native four-pose gate worst +6.40%, timing drift recorded. Missing upper pedestal/emblem explicit; actual summit39.8m. |
| Vidhana passage and stair collision | Integrated locally in9df5546 | Actual two-client passage/stair checks pass. Full-body geometry includes pitch/lean margin; blocked translation also rolls back heading.578 held-steering poses have zero overlap. Public auto-roam excludes known private approaches, manual graph unchanged. Generic building/NPC collision remains separate. |
| Landmark focus metadata | Integrated locally in9df5546 | Hidden source geometry excluded, stable IDs retained. Real helicopter hover fills actual dwell circle and displays rounded40m model height from emitted39.8m crown; OSM source data unchanged. |
