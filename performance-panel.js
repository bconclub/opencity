(() => {
 const panel=document.createElement('details');panel.id='performance-panel';panel.open=true;panel.innerHTML='<summary>Performance <span id="perf-summary">Measuring…</span></summary><dl></dl><small>Draw counts: custom 3D layers only. Basemap excluded. GPU utilization unavailable.</small>';document.body.append(panel);
